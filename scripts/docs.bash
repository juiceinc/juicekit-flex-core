...
"/Applications/Adobe Flash Builder 4/sdks/4.1.0/bin//asdoc" -doc-sources+=src/main/flex -package-description-file scripts/package-description-core.xml -main-title "JuiceKit Core API Documentation" -output target/asdoc-output/
